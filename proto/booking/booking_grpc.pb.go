...
type BookingServiceClient interface {
	...
	Confirm(ctx context.Context, in *ConfirmBookingRequest, opts ...grpc.CallOption) (*ConfirmBookingResponse, error)
...
func (c *bookingServiceClient) Confirm(ctx context.Context, in *ConfirmBookingRequest, opts ...grpc.CallOption) (*ConfirmBookingResponse, error) {
...
type BookingServiceServer interface {
	...
	Confirm(context.Context, *ConfirmBookingRequest) (*ConfirmBookingResponse, error)
...
func (UnimplementedBookingServiceServer) Confirm(context.Context, *ConfirmBookingRequest) (*ConfirmBookingResponse, error) {
...
func _BookingService_Confirm_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BookingServiceServer).Confirm(ctx, req.(*ConfirmBookingRequest))
	}
	return interceptor(ctx, in, info, handler)
}
